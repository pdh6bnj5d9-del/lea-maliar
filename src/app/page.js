    ...
    <>
      ...
      <div className="marquee-banner">
        <div className="marquee-content">
          ...
          <span>•</span>
          <a href="https://www.linkedin.com/in/leamaliar" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          <span>•</span>
      ...
      <section className="contact" id="contact">
        <div className="section-container">
          ...
          <div className="contact-links">
            ...
            <a href="https://www.linkedin.com/in/leamaliar" target="_blank" rel="noopener noreferrer" className="contact-link">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="https://wa.me/33612345678" target="_blank" rel="noopener noreferrer" className="contact-link">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
